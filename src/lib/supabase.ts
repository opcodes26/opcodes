...
export const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    category: 'ai_agents',
    short_description: 'Motor autônomo de categorização semântica de chamados de suporte e cálculo preditivo de SLA com Gemini 2.5 Flash, reduzindo em 85% o tempo de primeira resposta.',
  ...
  },
  {
    ...
    category: 'automation',
    short_description: 'Plataforma de coleta de telemetria contínua via SNMP, projeção de consumo de suprimentos e disparo autônomo de ordens de reposição antes do esgotamento.',
